...
class ContentTest extends BrowserTestBase {
  ...
  public function testPageContent() {
    ...
    $this->assertSession()->elementTextContains('css', 'main article h3', 'Support in your home');
    $this->assertSession()->elementTextContains('css', 'main article p', 'Support and equipment to help you live independently and safely.');
    ...
    $this->assertSession()->elementTextContains('css', 'main article', 'Due to current circumstances appointments with adult social care staff are now happening on the telephone.');
